...
CREATE TABLE user_farm_role_status (
...
ALTER TABLE users
    ADD CONSTRAINT fk_users_user_status_id FOREIGN KEY (user_status_id) REFERENCES user_status(user_status_id);
...
ALTER TABLE invitation
    ADD CONSTRAINT fk_invitation_invitation_status_id FOREIGN KEY (invitation_status_id) REFERENCES invitation_status(invitation_status_id);

ALTER TABLE invitation
    ADD CONSTRAINT fk_invitation_user FOREIGN KEY (inviter_user_id) REFERENCES users(user_id);

ALTER TABLE invitation
    ADD CONSTRAINT fk_invitation_role FOREIGN KEY (suggested_role_id) REFERENCES role(role_id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE notifications
    ADD CONSTRAINT fk_notifications_notification_status_id FOREIGN KEY (notification_status_id) REFERENCES notification_status(notification_status_id);

ALTER TABLE notifications
    ADD CONSTRAINT fk_notifications_user_id FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE;

ALTER TABLE notifications
    ADD CONSTRAINT fk_notifications_invitation_id FOREIGN KEY (invitation_id) REFERENCES invitation(invitation_id) ON DELETE CASCADE;
...
ALTER TABLE user_role_farm
    ADD CONSTRAINT fk_user_role_farm_user_farm_role_status_id FOREIGN KEY (user_farm_role_status_id) REFERENCES user_farm_role_status(user_farm_role_status_id);
...
ALTER TABLE farm
    ADD CONSTRAINT fk_farm_farm_status_id FOREIGN KEY (farm_status_id) REFERENCES farm_status(farm_status_id);
...
ALTER TABLE plot
    ADD CONSTRAINT fk_plot_plot_status_id FOREIGN KEY (plot_status_id) REFERENCES plot_status(plot_status_id);
...
ALTER TABLE transaction
    ADD CONSTRAINT fk_transaction_transaction_status_id FOREIGN KEY (transaction_status_id) REFERENCES transaction_status(transaction_status_id);
