...
CREATE TABLE user_farm_role_states (
...
ALTER TABLE users
    ADD CONSTRAINT fk_users_user_status_id FOREIGN KEY (user_status_id) REFERENCES user_states(user_status_id);
...
ALTER TABLE invitations
    ADD CONSTRAINT fk_invitation_invitation_status_id FOREIGN KEY (invitation_status_id) REFERENCES invitation_states(invitation_status_id);
...
ALTER TABLE notifications
    ADD CONSTRAINT fk_notifications_notification_status_id FOREIGN KEY (notification_status_id) REFERENCES notification_states(notification_status_id);
...
ALTER TABLE user_role_farm
    ADD CONSTRAINT fk_user_role_farm_user_farm_role_status_id FOREIGN KEY (user_farm_role_status_id) REFERENCES user_farm_role_states(user_farm_role_status_id);
...
ALTER TABLE farms
    ADD CONSTRAINT fk_farm_farm_status_id FOREIGN KEY (farm_status_id) REFERENCES farm_states(farm_status_id);
...
ALTER TABLE plots
    ADD CONSTRAINT fk_plot_plot_status_id FOREIGN KEY (plot_status_id) REFERENCES plot_states(plot_status_id);
...
ALTER TABLE transactions
    ADD CONSTRAINT fk_transaction_transaction_status_id FOREIGN KEY (transaction_status_id) REFERENCES transaction_states(transaction_status_id);
