...
CREATE TABLE user_farm_role_states (
    user_farm_role_state_id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name VARCHAR(45) NOT NULL UNIQUE
);
...
CREATE TABLE user_role_farm (
    ...
    user_id integer NOT NULL,
    farm_id integer NOT NULL,
    user_farm_role_state_id integer NOT NULL,
...
ALTER TABLE user_role_farm
    ADD CONSTRAINT fk_user_role_farm_user_farm_role_state_id FOREIGN KEY (user_farm_role_state_id) REFERENCES user_farm_role_states(user_farm_role_state_id);
