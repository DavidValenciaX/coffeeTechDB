...
CREATE INDEX idx_flowering_plot ON flowering USING btree (plot_id);

CREATE INDEX idx_flowering_status ON flowering USING btree (status_id);

CREATE INDEX idx_invitation_farm ON invitation USING btree (farm_id);

CREATE INDEX idx_notifications_notification_type ON notifications USING btree (notification_type_id);

CREATE INDEX idx_notifications_user ON notifications USING btree (user_id);

CREATE INDEX idx_plot_coffee_variety ON plot USING btree (coffee_variety_id);

CREATE INDEX idx_plot_farm ON plot USING btree (farm_id);

CREATE INDEX idx_role_permissions_permissions ON role_permission USING btree (permission_id);

CREATE INDEX idx_role_permissions_roles ON role_permission USING btree (role_id);

CREATE INDEX idx_transaction_plot_id ON transaction USING btree (plot_id);

CREATE INDEX idx_transaction_status_id ON transaction USING btree (status_id);

CREATE INDEX idx_transaction_transaction_category_id ON transaction USING btree (transaction_category_id);

CREATE INDEX idx_transaction_transaction_type_id ON transaction USING btree (transaction_type_id);

CREATE INDEX idx_user_role_farm_farm ON user_role_farm USING btree (farm_id);

CREATE INDEX idx_user_role_farm_roles ON user_role_farm USING btree (role_id);

CREATE INDEX idx_user_role_farm_user ON user_role_farm USING btree (user_id);
