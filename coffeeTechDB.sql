...
CREATE TABLE health_checks (
    ...
    status_id integer DEFAULT (SELECT status_id FROM status WHERE name = 'Pendiente' AND status_type_id = 12) NOT NULL
);
...
CREATE TABLE invitation (
    ...
    status_id integer DEFAULT (SELECT status_id FROM status WHERE name = 'Pendiente' AND status_type_id = 7) NOT NULL,
...
CREATE TABLE user_role_farm (
    ...
    user_id integer NOT NULL,
    farm_id integer NOT NULL,
    status_id integer DEFAULT (SELECT status_id FROM status WHERE name = 'Activo' AND status_type_id = 8) NOT NULL,
