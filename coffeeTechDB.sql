...
-- Crear la nueva tabla user_role
...
-- Modificar la tabla user_role_farm para usar user_role_id
...
-- Añadir claves foráneas para user_role
...
-- Añadir la nueva clave foránea a user_role
...
ALTER TABLE invitations
    ADD CONSTRAINT fk_invitation_referral_user FOREIGN KEY (referral_user_id) REFERENCES users(user_id);

ALTER TABLE invitations
    ADD CONSTRAINT fk_invitation_user FOREIGN KEY (referrer_user_id) REFERENCES users(user_id);
